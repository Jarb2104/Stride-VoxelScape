...
{
	/// <summary>
	/// An abstract base class for extending to implement an <see cref="IBoundedIndexable{Index3D,TValue}" />.
	...
	public abstract class AbstractBoundedIndexable3D<T> : AbstractIndexingBounds3D, IBoundedIndexable<Index3D, T>
	{
		/// <inheritdoc />
		public abstract T this[Index3D index] { get; set; }
		...
		/// <inheritdoc />
		public virtual bool TryGetValue(Index3D index, out T value) =>
			ReadOnlyIndexableUtilities.TryGetValue(this, index, out value);

		/// <inheritdoc />
		public virtual bool TrySetValue(Index3D index, T value) =>
