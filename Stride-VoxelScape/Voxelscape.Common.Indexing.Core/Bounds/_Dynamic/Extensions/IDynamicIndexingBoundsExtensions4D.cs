...
/// <summary>
/// Provides extension methods for use with implementations of the <see cref="IDynamicIndexingBounds{Index4D}"/> interface.
/// </summary>
public static class IDynamicIndexingBoundsExtensions4D
{
	/// <summary>
	...
	/// </returns>
	public static int GetCurrentLength(this IDynamicIndexingBounds<Index4D> bounds, Axis4D axis)
	{
		Contracts.Requires.That(bounds != null);
	...
	/// </returns>
	public static int GetCurrentLowerBound(this IDynamicIndexingBounds<Index4D> bounds, Axis4D axis)
	{
		Contracts.Requires.That(bounds != null);
