...
/// <summary>
/// Provides extension methods for use with implementations of the <see cref="IDynamicIndexingBounds{Index1D}"/> interface.
/// </summary>
public static class IDynamicIndexingBoundsExtensions1D
{
	/// <summary>
	...
	/// </returns>
	public static bool IsIndexInCurrentBounds(this IDynamicIndexingBounds<Index1D> bounds, Index1D index)
	{
	...
	/// </returns>
	public static int GetCurrentLength(this IDynamicIndexingBounds<Index1D> bounds, Axis1D axis)
	{
		Contracts.Requires.That(bounds != null);
	...
	/// </returns>
	public static int GetCurrentLowerBound(this IDynamicIndexingBounds<Index1D> bounds, Axis1D axis)
	{
		Contracts.Requires.That(bounds != null);
	...
	/// </returns>
	public static int GetCurrentUpperBound(this IDynamicIndexingBounds<Index1D> bounds, Axis1D axis)
	{
		Contracts.Requires.That(bounds != null);
