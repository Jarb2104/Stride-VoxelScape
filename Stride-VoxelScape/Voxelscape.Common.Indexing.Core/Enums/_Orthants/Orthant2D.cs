...
{
	/// <summary>
	/// An enumeration of flags used to identify an orthant in two dimensional space. An orthant is all space lying on a
	...
	public enum Orthant2D
	{
		...
		/// </summary>
		AllEqual = EqualX | EqualY,

		/// <summary>
		/// The orthant is greater than all axes.
		/// </summary>
		AllGreater = GreaterX | GreaterY,
	}
}
