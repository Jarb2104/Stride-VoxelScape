...
/// <summary>
/// Provides extension methods for common mathematical functions for <see cref="ushort"/>.
/// </summary>
public static class UShortExtensions
{
	...
	public static ushort DivideByRoundUp(this ushort value, ushort divisor) => (ushort)(((value - 1) / divisor) + 1);
}
