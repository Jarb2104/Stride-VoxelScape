...
{
	public abstract class AbstractCompositeConstantSerializer<TValue, T1, T2, T3, T4, T5, T6, T7> :
		AbstractCompositeSerializer<TValue, T1, T2, T3, T4, T5, T6, T7>, IConstantSerializerDeserializer<TValue>
	{
		public AbstractCompositeConstantSerializer(
			...
			: base(serialzierT1, serialzierT2, serialzierT3, serialzierT4, serialzierT5, serialzierT6, serialzierT7)
		{
