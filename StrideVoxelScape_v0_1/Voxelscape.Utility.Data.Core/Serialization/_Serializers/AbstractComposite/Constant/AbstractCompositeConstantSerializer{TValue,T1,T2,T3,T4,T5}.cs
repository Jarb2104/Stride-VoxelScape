...
{
	public abstract class AbstractCompositeConstantSerializer<TValue, T1, T2, T3, T4, T5> :
		AbstractCompositeSerializer<TValue, T1, T2, T3, T4, T5>, IConstantSerializerDeserializer<TValue>
	{
		public AbstractCompositeConstantSerializer(
			...
			: base(serialzierT1, serialzierT2, serialzierT3, serialzierT4, serialzierT5)
		{
