...
{
	public abstract class AbstractCompositeSerializer<TValue, T1, T2, T3, T4, T5, T6, T7, T8> :
		ISerializerDeserializer<TValue>
	{
		...
		private readonly ISerializerDeserializer<T8> serialzierT8;
		...
		public AbstractCompositeSerializer(
			...
			ISerializerDeserializer<T8> serialzierT8)
		{
			...
			this.serialzierT8 = serialzierT8;
		}
		...
		public TValue Deserialize(IBufferedArray buffer)
		{
			...
			T8 part8 = this.serialzierT8.Deserialize(buffer);
		...
		public TValue Deserialize(byte[] buffer, ref int index)
		{
			...
			T8 part8 = this.serialzierT8.Deserialize(buffer, ref index);

			return this.ComposeValue(part1, part2, part3, part4, part5, part6, part7, part8);
		}

		protected abstract TValue ComposeValue(
			T1 part1, T2 part2, T3 part3, T4 part4, T5 part5, T6 part6, T7 part7, T8 part8);
