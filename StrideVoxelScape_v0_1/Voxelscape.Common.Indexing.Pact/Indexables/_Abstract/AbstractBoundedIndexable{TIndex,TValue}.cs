...
{
	/// <summary>
	/// An abstract base class for extending to implement an <see cref="IBoundedIndexable{TIndex,TValue}" />.
	...
	public abstract class AbstractBoundedIndexable<TIndex, TValue> :
		AbstractIndexingBounds<TIndex>,
		IBoundedIndexable<TIndex, TValue>
		where TIndex : IIndex
	{
		/// <inheritdoc />
