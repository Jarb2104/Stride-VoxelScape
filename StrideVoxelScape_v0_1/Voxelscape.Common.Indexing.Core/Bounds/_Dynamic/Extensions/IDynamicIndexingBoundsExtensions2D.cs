...
/// <summary>
/// Provides extension methods for use with implementations of the <see cref="IDynamicIndexingBounds{Index2D}"/> interface.
/// </summary>
public static class IDynamicIndexingBoundsExtensions2D
{
	/// <summary>
	...
	/// </returns>
	public static int GetCurrentLength(this IDynamicIndexingBounds<Index2D> bounds, Axis2D axis)
	{
		Contracts.Requires.That(bounds != null);
	...
	/// </returns>
	public static int GetCurrentLowerBound(this IDynamicIndexingBounds<Index2D> bounds, Axis2D axis)
	{
		Contracts.Requires.That(bounds != null);
	...
	/// </returns>
	public static int GetCurrentUpperBound(this IDynamicIndexingBounds<Index2D> bounds, Axis2D axis)
	{
		Contracts.Requires.That(bounds != null);
