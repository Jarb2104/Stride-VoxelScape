...
{
	/// <summary>
	/// An abstract base class for extending to implement an <see cref="IDynamicallyBoundedIndexable{Index4D,TValue}" />.
	...
	public abstract class AbstractDynamicallyBoundedIndexable4D<T> :
		AbstractDynamicIndexingBounds4D,
		IDynamicallyBoundedIndexable<Index4D, T>
	{
		/// <inheritdoc />
		...
		/// <inheritdoc />
		public virtual bool TryGetValue(Index4D index, out T value) => ReadOnlyIndexableUtilities.TryGetValue(this, index, out value);

		/// <inheritdoc />
		public virtual bool TrySetValue(Index4D index, T value) => IndexableUtilities.TrySetValue(this, index, value);
