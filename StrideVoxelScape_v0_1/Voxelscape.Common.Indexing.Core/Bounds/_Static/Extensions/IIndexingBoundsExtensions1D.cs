...
/// <summary>
/// Provides extension methods for use with implementations of the <see cref="IIndexingBounds{Index1D}"/> interface.
/// </summary>
public static class IIndexingBoundsExtensions1D
{
	/// <summary>
	...
	/// </returns>
	public static bool IsIndexInBounds(this IIndexingBounds<Index1D> bounds, Index1D index)
	{
	...
	/// </returns>
	public static int GetLowerBound(this IIndexingBounds<Index1D> bounds, Axis1D axis)
	{
		Contracts.Requires.That(bounds != null);
	...
	/// </returns>
	public static int GetUpperBound(this IIndexingBounds<Index1D> bounds, Axis1D axis)
	{
		Contracts.Requires.That(bounds != null);
	...
	public static Index1D GetMiddleIndex(this IIndexingBounds<Index1D> bounds, bool roundUp = false)
	{
		Contracts.Requires.That(bounds != null);
