...
/// <summary>
/// Provides extension methods for use with implementations of the <see cref="IIndexingBounds{Index4D}"/> interface.
/// </summary>
public static class IIndexingBoundsExtensions4D
{
	/// <summary>
	...
	/// </returns>
	public static int GetLength(this IIndexingBounds<Index4D> bounds, Axis4D axis)
	{
		Contracts.Requires.That(bounds != null);
	...
	/// </returns>
	public static int GetUpperBound(this IIndexingBounds<Index4D> bounds, Axis4D axis)
	{
		Contracts.Requires.That(bounds != null);
	...
	public static Index4D GetMiddleIndex(this IIndexingBounds<Index4D> bounds, bool roundUp = false)
	{
		Contracts.Requires.That(bounds != null);
