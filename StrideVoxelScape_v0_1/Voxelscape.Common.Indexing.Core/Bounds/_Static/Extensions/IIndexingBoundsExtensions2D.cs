...
/// <summary>
/// Provides extension methods for use with implementations of the <see cref="IIndexingBounds{Index2D}"/> interface.
/// </summary>
public static class IIndexingBoundsExtensions2D
{
	/// <summary>
	...
	/// </returns>
	public static int GetLength(this IIndexingBounds<Index2D> bounds, Axis2D axis)
	{
		Contracts.Requires.That(bounds != null);
	...
	/// </returns>
	public static int GetLowerBound(this IIndexingBounds<Index2D> bounds, Axis2D axis)
	{
		Contracts.Requires.That(bounds != null);
