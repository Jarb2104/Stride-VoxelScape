...
{
	/// <summary>
	/// An abstract base class for extending to implement an <see cref="IBoundedIndexable{Index2D,TValue}" />.
	...
	public abstract class AbstractBoundedIndexable2D<T> : AbstractIndexingBounds2D, IBoundedIndexable<Index2D, T>
	{
		/// <inheritdoc />
		public abstract T this[Index2D index] { get; set; }
		...
		/// <inheritdoc />
		public virtual bool TryGetValue(Index2D index, out T value) =>
			ReadOnlyIndexableUtilities.TryGetValue(this, index, out value);

		/// <inheritdoc />
		public virtual bool TrySetValue(Index2D index, T value) =>
